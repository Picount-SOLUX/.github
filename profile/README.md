...
사용자들의 Pain Point로부터 출발한 PICOUNT는  
다음과 같은 문제를 해결하기 위해 기능을 설계했습니다.

| Pain Point | Insight |
|------------|---------|
| 📊 체계적인 예산 관리를 원하는 사용자 | 카테고리별 예산 조각 기능 및 시각화 제공 |
| 💤 기록 습관을 유지하기 어려운 사용자 | 감정 스티커 및 다이어리형 꾸미기 기능 |
| 💬 가계부 작성을 처음 해보는 사용자 | 직군별 예산 추천 및 자동 적용 기능 |
...
- 예산 설정 단계에서 **추천 템플릿을 적용**하거나 직접 세분화할 수 있습니다
...
- **출석 체크, 포인트, 챌린지** 기능을 통해 꾸준한 기록 습관을 자연스럽게 형성할 수 있습니다.
...
| 이름 | 역할 |
|------|------|
| [장유진](https://github.com/janguzin) | PM |
| [조예율]() | Design |
| [김다은](https://github.com/Daeun-Kim701) | Frontend |
| [조시은](https://github.com/singnyee) | Frontend |
| [문수정](https://github.com/sujeongmoon) | Backend |
| [정선우](https://github.com/jsssun) | Backend |
| [홍세민](https://github.com/semsemin) | Backend |
